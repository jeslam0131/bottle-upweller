...
MQTT_PORT = 1883
TOPIC_COMMAND = "bupsy/motorCommand"
TOPIC_STATUS = "bupsy/status"

def on_message(client, userdata, message):
    print("ARDUINO:", message.payload.decode())
    ...
    if prev_gray is not None:
        ...
        if video_time - last_control_time >= CONTROL_PERIOD:
            ...
            if video_time - last_send_time >= SEND_PERIOD:
                ...
                mqtt_client.publish(TOPIC_COMMAND, str(int(command_to_send)))
